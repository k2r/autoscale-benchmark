...
import stormBench.stormBench.operator.bolt.benchmark.CityNormalizerSensitive;
 ...
 *
 */
public class ComplexSensitiveTopology {
	...
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException, AuthorizationException, ParserConfigurationException, SAXException, IOException {
        ...
        if(grouping.equalsIgnoreCase("shuffle")){
        	...
        	builder.setBolt("SensitiveBolt", new CityNormalizerSensitive(), heavyNbExecutors)
        	...
        	.setCPULoad(lightCpuConstraint).setMemoryLoad(heavyMemConstraint).setNumTasks(1)
        	...
        	.setCPULoad(heavyCpuConstraint).setMemoryLoad(heavyMemConstraint).setNumTasks(1)
        ...
        if(grouping.equalsIgnoreCase("osg")){
            ...
            builder.setBolt("CityAnalyzer", new CityAnalyzer(100), lightNbExecutors)
            .setCPULoad(lightCpuConstraint).setMemoryLoad(heavyMemConstraint).setNumTasks(1)
            .customGrouping("SensitiveBolt", new OSGCustomGrouping(49991L, 0.05, 0.05));
